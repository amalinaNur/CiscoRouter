...
<?php require_once('PHPTelnet.php'); ?>
<?php
...
/*$intSerialErr = $hostErr = $subnetMaskErr = "";
$intSerial = $host = $subnetMask = "";

if ($_SERVER["REQUEST_METHOD"] == "POST") 
{
  if (empty($_POST["intSerial"])) 
  {
    $intSerialErr = "Serial Interface is required";
  } 
  else 
  {
    $intSerial = test_input($_POST["intSerial"]);
  }
  
  if (empty($_POST["host"])) 
  {
    $hostErr = "IP Address is required";
  } 
  else 
  {
  ...
  {
    $subnetMaskErr = "Subnet Mask is required";
  } 
  else 
  {
...
<title>Default IP Address Router</title>
...
<table width="1085" border="1" class="table" align="center">
  <tr>
...
<td valign="top" bgcolor="#FFFFFF">
      ...
      <div align="center" >
      <a href="default_router.php">Interface Fast Ethernet</a>
      |
      <a href="default_router1.php">Interface Serial</a>
      </div>
      <br />
      <div align="center" >
      <form action="<?php echo htmlspecialchars("showRun.php");?>" method="POST" name="hostname_form">
      <br />
      <label>Interface Serial: </label>
      <input type="text" name="intSerial" autofocus="autofocus" required="required" value="<?php echo $intSerial;?>"/>
      <br /><br />
      
      <label>IP Address: </label>
      <input type="text" name="host" autofocus="autofocus" required="required" value="<?php echo $host;?>"/>
      <br /><br />
      
      <label>Subnet Mask: </label>
      <input type="text" name="subnetMask" autofocus="autofocus" required="required" value="<?php echo $subneMask;?>"/>
      <br /><br />
      
      <input type="hidden" value="<?php echo $intSerial;
	  echo $host;
	  echo $subneMask;
  ...
  case 0:
	...
	$telnet->DoCommand("interface serial $intSerial", $out);
	echo $out."";
  ...
  case 4:
	...
	break;
	  ...
	  <input name="submit" type="submit" value="Save" onclick="myFunction()" />
      <br /><br />
      </form> 
      </div>
    </td>
