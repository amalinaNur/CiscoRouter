...
<td valign="top" bgcolor="#FFFFFF">
      ...
      <div align="center">
      <form action="<?php echo htmlspecialchars("showRun.php");?>" method="POST" name="telnet_form">
      <br>
      <?php /*?><p style="font-size:18px">Change Password Telnet</p><?php */?>
      <label>Change Password Console: </label>
      ...
      <form>
      <label>Change Password Telnet: </label>
	  ...
	  case 0:
		...
		$telnet->DoCommand("line console 0", $out);
		echo $out."\n";
		
		usleep(100000);
		
		$telnet->DoCommand("password $pass1", $out);
		echo $out."\n";//a line for the command-line
	
		sleep(1);
		
		$telnet->DoCommand("login", $out);
		echo $out."\n";
		...
		$telnet->DoCommand("line vty 0 4", $out);
		echo $out."\n";
		
		usleep(100000);
		
		$telnet->DoCommand("password $pass", $out);
		echo $out."\n";//a line for the command-line
