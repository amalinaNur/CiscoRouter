...
<td valign="top" bgcolor="#FFFFFF">
      ...
      <br />
      <p style="font-size:18px">Change Hostname of Router</p>
      <label>Hostname: </label>
      <input type="text" name="hostname" autofocus="autofocus" required="required" value="<?php echo $hostname;?>"/>
