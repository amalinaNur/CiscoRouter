...
<title>Show IP Interfaces</title>
...
<td valign="top" bgcolor="#FFFFFF">
      ...
      <textarea name="command_prompt" wrap="on" readonly="readonly" class="boxIP"><?php
  ...
  case 0:
	...
	$telnet->DoCommand("show ip interface brief", $out);
	echo $out."\n";
...
<script>
	...
	var textarea2 = document.getElementById("boxShow");
    function showRun() {

       textarea2.value = button.value.split(" ").sort().join(" ")
    }
</script>
</body>
</html>
