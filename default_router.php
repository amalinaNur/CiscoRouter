...
//$intFastEthErr = $hostErr = $subnetMaskErr = "";
/*$intFastEth = "";
$host = "";
$subnetMask = "";
...
{
  if (!empty($_POST["intFastEth"])) 
  {
    $intFastEth = test_input($_POST["intFastEth"]);
  }
...
<td valign="top" bgcolor="#FFFFFF">
      ...
      <br />
      <label>Interface Fast Ethernet: </label>
      <input type="text" name="intFastEth" autofocus="autofocus" value="<?php echo $intFastEth;?>"/>
      <br /><br />
      
      <label>IP Address: </label>
      <input type="text" name="host" autofocus="autofocus" value="<?php echo $host;?>"/>
      <br /><br />
      
      <label>Subnet Mask: </label>
      <input type="text" name="subnetMask" autofocus="autofocus" value="<?php echo $subneMask;?>"/>
      <br /><br />
